...
## Notas
1. Se mantuvo lo mas simple posible para no agregar mas librerias como RXjava para este entregable, a excepción de usar Room que simplifica mucho las cosas. Para ejecutar las operaciones de base de datos se uso ExecutorService.
2. Uso de MVP.
...
4. Version de Android Studio: Android Studio Narwhal | 2025.1.1
